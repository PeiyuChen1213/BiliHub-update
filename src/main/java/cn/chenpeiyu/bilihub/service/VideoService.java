...
import cn.chenpeiyu.bilihub.dao.VideoDao;
import cn.chenpeiyu.bilihub.domain.*;
import cn.chenpeiyu.bilihub.domain.exception.ConditionException;
import cn.chenpeiyu.bilihub.util.FastDFSUtil;
import cn.chenpeiyu.bilihub.util.ImageUtil;
import cn.chenpeiyu.bilihub.util.IpUtil;
...
public class VideoService {
    ...
    public List<VideoBinaryPicture> convertVideoToImage(Long videoId, String fileMd5) throws Exception{
        cn.chenpeiyu.bilihub.domain.File file = fileService.getFileByMd5(fileMd5);
